...
@Teleop(name = "My Teleop Controller", group = "Group 1")
public class MyTeleopController implements OpMode {
    ...
    public MyTeleopController(Robot robot)
    {
        this.robot = robot;
    }
  ...
  public void start() {
    System.out.println("MyTeleopController start");
    Telemetry.log("Mode", "MyTeleopController");
    scheduler.schedule(RomiDrivetrain.printWheelEncoders());
    scheduler.schedule(MyCommands.printGyro());
  }
   ...
   */
  public void end() {
    System.out.println("MyTeleopController end");
  }
   ...
   */
  public void close() {
    System.out.println("MyTeleopController close");
  }
}
